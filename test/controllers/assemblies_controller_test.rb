...
class AssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assembly" do
    assert_difference('Assembly.count') do
      post assemblies_url, params: { assembly: { percentage: @assembly.percentage, strain: @assembly.strain, wine: @assembly.wine } }
    end
  ...
  test "should update assembly" do
    patch assembly_url(@assembly), params: { assembly: { percentage: @assembly.percentage, strain: @assembly.strain, wine: @assembly.wine } }
